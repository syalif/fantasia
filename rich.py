...
ki = LINETCR.LINE()
ki.login(token="EmaIQulVo0gCLOP6iiQ9.2SozhwGBFV9FQbKJq2aRAq.nRMfuHXc1YUIWbxxNyV+SQ0+FHkfTNTEonW1EBqo+SM=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmkNs5SbJ37g2tBc8Gd6.ryL8meN5fHOxOBvDACRubG.G1Wtmb3GpoCY8JTGmm5EWfQyVPeQMMbymqKE2rdgACU=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EmfZdZxCmTy790MmrUe3.hTXdG8h81i+OiiRYtl44GW.iJAwB1MB7vTqvVoCc3avqosJyZbbtIHoD5vtI+ipmpE=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EmW2HcNCXF61J9m7V7Da.Hx4ffYagGfK/oXPvFOxTYG.PeY1hFZOCufNgkUEmhJv9cMaikaJC5ZZBPa0lZtXrys=")
kd.loginResult()

ko = LINETCR.LINE()
ko.login(token="EmnjrZPaA69W1wQxz9g8.hPrV+ZLnHu0A+4VN6WDdQa.2Chlyr5pYZTb0MNZn/xTy+K7JWolCxJuMDGpFfJg28s=")
ko.loginResult()
...
helpMessage =""" F̸͟͞ãn̺͆t͢a͆s͎i͠i̶ǟ βo̸t̫
...
▶Protect On/Off
▶Deff Join On/Off = Protect Join On/Off
▶Namabot say ""
▶Bot?
▶Me [Bot akan Mengirim kontak kamu]
...
↗Ourl
↗Curl
↗Masuk/Sini Masuk/Yang Lain Suruh Masuk/Sayang
↗Ban @
↗Unban @
↗Speed
↗Bc ""
...
Kmid = ko.getProfile().mid

Bots=[mid,Amid,Bmid,Cmid,Dmid,Kmid]
admin=["ufa308a279f813fa5b17bf3bb2a56f403","u162e9820c437e180a8e6b77d08c6100e","u32e6d670aeab696b817073392ead18cb","u2c769d713e7a7fcb269e5501320b5235"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks for add me ^-^ Message By : Fantasia Bot :*",
    "lang":"JP",
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            if op.param2 in Bots:
                return
            kk.sendText(op.param1,cl.getContact(op.param2).displayName +   "Welcome\n(*´･ω･*)")
       ...
       #----Joined User Kick Finish-------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Key","help","Help","Fantasia Help"]:
               ...
               if msg.from_ in admin:
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Red Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Verdandi Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Urd Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                kc.sendMessage(msg)
            elif msg.text in ["æ„›ã^a®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Athena Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                kd.sendMessage(msg)
            elif msg.text in ["æ„›ã^a®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Nixie Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                kc.sendText(msg.to,Cmid)
            elif msg.text in ["Wkwk","wkwk","Wkwkwk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
            ...
            elif msg.text in ["Deff Join On","Protect Join On"]:
               if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"kick Joined Group ON")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"done")
            elif msg.text in ["Deff Join Off","Protect Join Off"]:
               if msg.from_ in admin:
                if wait["Protectjoin"] == False:
                    if wait["lang"] == "JP":
                        kd.sendText(msg.to,"kick Joined Group Off")
                    else:
                        kd.sendText(msg.to,"done")
                else:
               ...
               if msg.from_ in admin:
                ...
                if wait["leaveR-oom"] == True: md+=" ✔Auto leave : on\n"
...
#-----------------------------------------------
            ...
            elif msg.text in ["All join","Masuk","Fantasia join","Sini Masuk","Sayang","Yang Lain Suruh Masuk"]:
              if msg.from_ in admin:
                        cl.sendText(msg.to, "Ok Siap✈")
                        ...
                        time.sleep(0.2)
                        cl.sendText(msg.to, "Bot Dah Join Semua💋 Ketik Absen")
                        G = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        cl.updateGroup(G)
                        print "Join Bot Semua"
            ...
            elif msg.text in ["Verdandi join"]:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0
                  ...
                  kd.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Bye all","Keluar Dong","Bubar"]:
               if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        random.choice(KAC).sendText(msg.to,"Bubar Bubar😪")
               ...
               if msg.from_ in admin:
                if msg.toType == 2:
                 if op.param2 not in Bots and admin:
                    ...
                    ki.sendText(msg.to,"Unchh 😙")
                    kk.sendText(msg.to,"Bye Semua😌")
                    kc.sendText(msg.to,"Fuck You All")
                    kd.sendText(msg.to,":v")
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ki.sendText(msg.to,"Succes Banned")
                                kk.sendText(msg.to,"Succes Banned")
                                kc.sendText(msg.to,"Succes Banned")
                                kd.sendText(msg.to,"Succes Banned")
                            except:
                                ki.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Unbanned Anggota Berhasil")
                                ki.sendText(msg.to,"Unbanned Anggota Berhasil")
                                kk.sendText(msg.to,"Unbanned Anggota Berhasil")
                                kc.sendText(msg.to,"Unbanned Anggota Berhasil")
                                kd.sendText(msg.to,"Unbanned Anggota Berhasil")
                            except:
                                ki.sendText(msg.to,"Succes Cv")
...
#--------------------------------------------------
            elif msg.text in ["Halo","Hai","hai","halo","Hi","hi"]:
               salam=['Hai juga beb','kmu siapa y?','Gaje nih anak','Haiii','Iyain','Krik Krik....']
               msg = random.choice(salam)
               random.choice(KAC).sendMessage(msg)
            elif msg.text in ["Aku siapa?","Kalo aku?","aku siapa?","Aku Siapa?","kalo aku?","Kalo Aku?"]:
               bales=['Manusia','Justin bieber','Mimi Peri','Raisa','Penggemar Micin','Hode','kuntilanak','Genderuwo','Iblis','Anjingg :v','Maria ozawa.']
               msg = random.choice(bales)
               random.choice(KAC).sendMessage(msg)
#--------------------------------------------------
            elif "Bc " in msg.text:
                       if msg.from_ in admin:
...
#-----------------------------------------------
            elif "Skuld say " in msg.text:
                       if msg.from_ in admin:
                                bctxt = msg.text.replace("Skuld say ","")
                                cl.sendText(msg.to, (bctxt))
            elif "Red say " in msg.text:
                     if msg.from_ in admin:
                              bctxt = msg.text.replace("Red say ","")
                              ki.sendText(msg.to, (bctxt))
            elif "Verdandi say " in msg.text:
                     if msg.from_ in admin:
                              bctxt = msg.text.replace("Verdandi say ","")
                              kk.sendText(msg.to, (bctxt))
            elif "Urd say " in msg.text:
                     if msg.from_ in admin:
                              bctxt = msg.text.replace("Urd say ","")
                              kc.sendText(msg.to, (bctxt))
            elif "Athena say " in msg.text:
                       if msg.from_ in admin:
                                bctxt = msg.text.replace("Athena say ","")
                                kd.sendText(msg.to, (bctxt))
            elif "Nixie say " in msg.text:
                       if msg.from_ in admin:
                                bctxt = msg.text.replace("Nixie say ","")
                                ko.sendText(msg.to, (bctxt))
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Grup ini :)")
...
#-----------------------------------------------
               ...
               if msg.from_ in admin:
                cl.sendText(msg.to,"Skuld's")
                ki.sendText(msg.to,"Red Riding Hood")
                kk.sendText(msg.to,"Verdandi")
                kc.sendText(msg.to,"Urd")
                kd.sendText(msg.to,"Athena")
                ko.sendText(msg.to,"Nixie")
#-----------------------------------------------
...
#----------------------------------------------------------------
               ...
               if msg.from_ in creator:
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    ko.sendText(msg.to, "Bio Updated.")
#----------------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                ko.sendMessage(msg)
#-----------------------------------------------------------------
            elif msg.text in ["Bot:Refresh","Bot:refresh"]:
               if msg.from_ in admin:
                ...
                kd.sendText(msg.to,"Refresh Done")
                ko.sendText(msg.to,"Refresh Done")
#-----------------------------------------------------------------
...
#-----------------------------------------------------------------
                ...
                if msg.toType == 2:
                      msg.contentType = 13
                      Creatorbot = "ufa308a279f813fa5b17bf3bb2a56f403"
                      try:
                          msg.contentMetadata = {'mid': Creatorbot}
                      except:
                        Creatorbot = "Error"
                      cl.sendText(msg.to, "My Creator : SyalifR🔖🔥")
                      random.choice(KAC).sendMessage(msg)
#------------------------------------------------------------------
                ...
                if msg.toType == 2:
                      ...
                      cl.sendText(msg.to, "Contact Admin")
                      random.choice(KAC).sendMessage(msg)
#--------------------------------------------------------------------
            elif msg.text in ["Clear ban"]:
              if msg.from_ in admin:
                wait["blacklist"] = {}
                kc.sendText(msg.to, "Banlist Hasbeen Deleted.")
#------------------------------------------------------------------
...
#-----------------------------------------------------------
            ...
            elif "/RedChangename: " in msg.text:
                if msg.from_ in admin:
                    string = msg.text.replace("/RedChangename: ","")
                    if len(string.decode('utf-8')) <= 20:
                        profile = ki.getProfile()
                        profile.displayName = string
                        ki.updateProfile(profile)
            ...
            elif "/UrdChangename: " in msg.text:
                if msg.from_ in admin:
                    string = msg.text.replace("/UrdChangename: ","")
                    if len(string.decode('utf-8')) <= 20:
                        profile = kc.getProfile()
                        profile.displayName = string
                        kc.updateProfile(profile)
            ...
            elif "/NixieChangename: " in msg.text:
                if msg.from_ in admin:
                    string = msg.text.replace("/NixieChangename: ","")
                    if len(string.decode('utf-8')) <= 20:
                        profile = ko.getProfile()
                        profile.displayName = string
                        ko.updateProfile(profile)
                        ko.sendText(msg.to,"Ganti nama menjadi \"" + string + "\" berhasil")
#----------------------------------------------------------------
