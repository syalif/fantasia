...
cl = LINETCR.LINE()
cl.login(token="EmA67mLv0YfgSujcgl2d.rQI3sHKUFOJycabz4N2cBq.15BCcb9VrStTeJagN/ch5szY9UttNMEUhH0dJGH0dzA=")

ki = LINETCR.LINE()
ki.login(token="Elo09hrSuKTDcOXu8L83.ui4iewdkcsL+LbOtFNA/eW.ul6eXzv2fyWoniZ6ATetCT0G06CXOE2p4xL2f/zSZQM=")

kk = LINETCR.LINE()
kk.login(token="El9vMwqsUaAhtNdn1vp0.L35okPRiB0SeAjVsPXm88a.C0QR/WXPkd0zaWULrO9vUj/MDVLuSRU7dlhjh1J11yw=")
...
admin=["ufa308a279f813fa5b17bf3bb2a56f403"]
...
#------Cancel User Kick start------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               ...
               if msg.from_ in admin:
                ...
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Skuld Gift"]:
               if msg.from_ in admin:
                msg.contentType = 9
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Skuld Gift2"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Skuld Gift3"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Skuld Gift4"]:
               if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
		...
		for ticket_id in n_links:
                ...
                if wait["clock"] == True:
            ...
            elif msg.text == "Liat sider":
                   cl.sendText(msg.to, "Bot akan melihat sider ^~^")
                   try:
                   ...
                   print "sukses"
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "An already read point has been created")
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "Bye sucker" in msg.text:
               if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Bye sucker","")
...
#-----------------------------------------------
               ...
               if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Sebentar Coeg...")
